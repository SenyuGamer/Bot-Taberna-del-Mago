...
import { bienvenida } from "./src/commands/bienvenida.js";
...
const body = [estrellitas, estrellitasNegras, inspiracion, dm, registros, sincronizar, hora, musica, bienvenida].map((c) =>
  c.data.toJSON()
);
